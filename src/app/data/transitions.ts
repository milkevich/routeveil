...
const transitionCopy = {
  ...
  pixel: {
    ...
    options: 'columns, rows, color, origin: top-left | top-right | bottom-left | bottom-right | center | random | cursor, duration, stagger',
  ...
  curtain: {
    ...
    options: 'color, axis: horizontal | vertical, duration, easing',
  ...
  wipe: {
    ...
    options: 'color, direction: right | left | down | up, duration, easing',
  ...
  columns: {
    ...
    options: 'columns, count, direction: down | up | alternate, order: forward | reverse | center, color, duration, stagger, easing',
  ...
  rows: {
    ...
    options: 'rows, count, direction: right | left | alternate, order: forward | reverse | center, color, duration, stagger, easing',
  ...
  iris: {
    ...
    options: 'color, origin: cursor | center, duration, easing',
  ...
  tunnel: {
    ...
    options: 'color, origin: cursor | center, duration, coverDuration, revealDuration, easing',
  ...
  clock: {
    ...
    options: 'color, origin: cursor | center, direction: clockwise | counterclockwise, startAngle, duration, easing',
  ...
  venetian: {
    ...
    options: 'color, direction: horizontal | vertical, count, alternate, duration, stagger',
  ...
  mosaic: {
    ...
    options: 'colors, columns, rows, duration, stagger, rotation, seed, origin: cursor | center | random',
